        ...
        <div className=''>
          ...
          >
            {/* <img
                src={url}
  alt="Listing"
  className="max-h-[450px] w-auto object-contain items-center "
            />
           */}
            {/* <div className='h-[450px] max-w-[440px] justify-center item-center flex ml-10 mt-5 bg-cover bg-center bg-no-repeat  w-auto object-contain' style={{backgroundImage:`url('${url}')`}}>
            </div> */}
